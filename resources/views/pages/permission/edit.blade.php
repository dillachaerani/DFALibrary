...
@php $lang = "permission_lang"; @endphp
...
@section('css')
@include('pages.permission.form.form-css')
@endsection
...
@section('content')
    <div class="layout-px-spacing">
        <div class="account-settings-container layout-top-spacing">
            {!! Form::model($permission, ['url' => action('PermissionController@update', encrypt($permission->id)), 'method' => 'put', 'files' => true])  !!}
                                ...
                                @component('components.widget', ['title' => __("$lang.title.edit")])
                                    @slot('content')
                                        <div id="general-info" class="section general-info">
                                            <div class="info">
                                                @include('pages.permission.form.form')
                                            </div>
                                        </div>
                                    @endslot
                                @endcomponent
...
@include('pages.permission.form.form-js')
@endsection
