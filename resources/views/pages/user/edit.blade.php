...
@section('css')
@include('pages.user.form.form-css')
@endsection
...
@section('content')
    <div class="layout-px-spacing">
        <div class="account-settings-container layout-top-spacing">
            {!! Form::model($user, ['url' => action('UserController@update', encrypt($user->id)), 'method' => 'put', 'files' => true])  !!}
...
@include('pages.user.form.form-js')
@endsection
